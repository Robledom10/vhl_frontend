...
export class OperacionesService {
	...
	// --- Restaurantes ---
	getRestaurantes(idViaje: number): Observable<Restaurante[]> {
		return this.http.get<Restaurante[]>(`${this.base}/viajes/${idViaje}/restaurantes`);
	}
	asignarRestaurante(idViaje: number, body: object): Observable<Restaurante> {
		return this.http.post<Restaurante>(`${this.base}/viajes/${idViaje}/restaurantes`, body);
	}
	actualizarRestaurante(idViaje: number, id: number, body: object): Observable<Restaurante> {
		return this.http.put<Restaurante>(`${this.base}/viajes/${idViaje}/restaurantes/${id}`, body);
	}
	eliminarRestaurante(idViaje: number, id: number): Observable<void> {
		return this.http.delete<void>(`${this.base}/viajes/${idViaje}/restaurantes/${id}`);
	}
	...
	actualizarNotificacion(idViaje: number, id: number, body: object): Observable<Notificacion> {
		return this.http.put<Notificacion>(`${this.base}/viajes/${idViaje}/notificaciones/${id}`, body);
	}
	...
	getAllPaquetes(): Observable<{ id: number; titulo: string; destino: string; fechaInicio: string; duracionDias: number }[]> {
